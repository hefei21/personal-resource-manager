...
.button:focus-visible,.scenario-switch button:focus-visible,.journey-card:focus-visible,.text-danger:focus-visible,input:focus-visible{outline:2px solid var(--color-focus-ring);outline-offset:2px}.button.primary{color:var(--color-text-inverse);border-color:var(--color-primary);background:var(--color-primary-solid)}.button.secondary{color:var(--color-primary);border-color:var(--color-primary-border)}.button.ghost{color:var(--color-text-secondary);background:transparent}.button:disabled,button:disabled{cursor:not-allowed;opacity:var(--opacity-disabled)}
