...
export default {
  ...
  anime: {
    ...
    latestProposal: (id) => api.get(`/anime/${id}/proposals/latest`),
    getProposal: (taskId, id) => api.get(`/anime/${id}/proposals/${taskId}`),
    applyProposal: (taskId, id) => api.post(`/anime/${id}/proposals/${taskId}/apply`),
    ...
    delete: (id, baseVersion) => api.delete(`/anime/${id}`, { data: { baseVersion } }),
    toggleFavorite: (id, baseVersion) => api.post(`/anime/${id}/favorite`, { baseVersion }),
    updateStatus: (id, status, baseVersion) => api.post(`/anime/${id}/status`, { status, baseVersion }),
    updateRating: (id, rating, baseVersion) => api.post(`/anime/${id}/rating`, { rating, baseVersion }),
    ...
    toggleHidden: (id, baseVersion) => api.put(`/anime/${id}/toggle-hidden`, { baseVersion })
  },
  search: {
  ...
  games: {
    latestProposal: () => api.get('/games/steam/proposals/latest'),
    getProposal: (taskId) => api.get(`/games/steam/proposals/${taskId}`),
    applyProposal: (taskId) => api.post(`/games/steam/proposals/${taskId}/apply`),
    ...
    delete: (id, baseVersion) => api.delete(`/games/${id}`, { data: { baseVersion } }),
    toggleFavorite: (id, baseVersion) => api.post(`/games/${id}/favorite`, { baseVersion }),
    updateStatus: (id, status, baseVersion) => api.post(`/games/${id}/status`, { status, baseVersion }),
    updateRating: (id, rating, baseVersion) => api.post(`/games/${id}/rating`, { rating, baseVersion }),
