...
export const NAVIGATION_GROUPS = Object.freeze({
  home: Object.freeze({ key: 'home', label: '首页', order: 0, pcIcon: 'home' }),
  library: Object.freeze({ key: 'library', label: '资源库', order: 1, pcIcon: 'stack' }),
  collection: Object.freeze({ key: 'collection', label: '收藏', order: 2, pcIcon: 'star' }),
  workspace: Object.freeze({ key: 'workspace', label: '工作台', order: 3, pcIcon: 'briefcase' }),
  system: Object.freeze({ key: 'system', label: '系统', order: 4, pcIcon: 'sliders-horizontal' })
})
