...
<style scoped>
.ebook-reader{position:fixed;inset:0;z-index:12000;display:grid;grid-template-rows:64px auto minmax(0,1fr) 72px;background:var(--color-surface-subtle);color:var(--color-text-primary)}.ebook-reader__header{display:flex;align-items:center;gap:14px;padding:0 22px;border-bottom:1px solid var(--color-border-default);background:var(--color-surface-raised)}.ebook-reader__identity{min-width:0;display:flex;flex:1;flex-direction:column}.ebook-reader__identity strong{overflow:hidden;font-size:16px;text-overflow:ellipsis;white-space:nowrap}.ebook-reader__identity span,.ebook-reader__panel-heading span{font-size:12px;color:var(--color-text-muted)}.ebook-reader__header-actions{display:flex;gap:4px}.ebook-reader__icon-button{width:40px;height:40px;padding:0}.ebook-reader__notice{display:flex;align-items:center;justify-content:center;gap:10px;min-height:44px;padding:6px 20px;background:var(--color-primary-surface);color:var(--color-info-text)}.ebook-reader__notice--warning{background:var(--color-warning-surface);color:var(--color-warning-text)}.ebook-reader__surface{min-height:0;overflow:auto;padding:36px 56px;scrollbar-gutter:stable}.ebook-reader__surface--paper{background:#edf0f4}.ebook-reader__surface--warm{background:#e8dfd0}.ebook-reader__surface--dark{background:#171a21}.ebook-reader__paper{width:min(780px,100%);min-height:calc(100vh - 250px);box-sizing:border-box;margin:0 auto;padding:68px 78px;border:1px solid rgba(76,90,116,.12);border-radius:8px;background:#fffdf9;box-shadow:0 12px 36px rgba(40,48,65,.08);line-height:1.85;color:#273244}.ebook-reader__surface--warm .ebook-reader__paper{background:#fbf3e4;color:#3c3328}.ebook-reader__surface--dark .ebook-reader__paper{border-color:#333a47;background:#232832;color:#e4e8ef}.ebook-reader__pdf-stage{display:flex;justify-content:center;min-height:100%;padding:0 0 40px}.ebook-reader__pdf-canvas{align-self:flex-start;max-width:none;border:1px solid #d6dce5;background:#fff;box-shadow:0 12px 38px rgba(32,42,60,.16)}.ebook-reader__state{height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;color:var(--color-text-secondary)}.ebook-reader__state strong{font-size:16px;color:var(--color-text-primary)}.ebook-reader__state--error>div{display:flex;gap:10px;margin-top:8px}.ebook-reader__toc,.ebook-reader__settings{position:fixed;top:64px;bottom:0;z-index:12002;width:min(360px,90vw);display:flex;flex-direction:column;background:var(--color-surface-raised);box-shadow:0 16px 48px rgba(30,37,50,.18);transition:transform .22s ease}.ebook-reader__toc{left:0;transform:translateX(-105%)}.ebook-reader__settings{right:0;transform:translateX(105%)}.ebook-reader__toc--open,.ebook-reader__settings--open{transform:translateX(0)}.ebook-reader__panel-heading{display:flex;align-items:center;justify-content:space-between;padding:18px 20px;border-bottom:1px solid var(--color-border-subtle)}.ebook-reader__panel-heading>div{display:flex;flex-direction:column;gap:2px}.ebook-reader__toc-list{overflow:auto;padding:10px}.ebook-reader__toc-list button{width:100%;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 12px;border:0;border-radius:8px;background:transparent;color:var(--color-text-secondary);text-align:left;cursor:pointer}.ebook-reader__toc-list button:hover{background:var(--color-surface-subtle)}.ebook-reader__toc-list button.active{background:var(--color-primary-surface);color:var(--color-primary)}.ebook-reader__toc-list span{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ebook-reader__toc-list small{color:var(--color-text-muted)}.ebook-reader__setting-group{display:flex;flex-direction:column;gap:10px;padding:18px 20px;border-bottom:1px solid var(--color-border-subtle)}.ebook-reader__setting-group label{font-size:13px;color:var(--color-text-secondary)}.ebook-reader__stepper{display:grid;grid-template-columns:1fr 80px 1fr;align-items:center;gap:8px;text-align:center}.ebook-reader__segmented{display:grid;grid-template-columns:repeat(3,1fr);gap:6px}.ebook-reader__segmented button{min-height:38px;border:1px solid var(--color-border-default);border-radius:8px;background:var(--color-surface-raised);color:var(--color-text-secondary);cursor:pointer}.ebook-reader__segmented button.active{border-color:var(--color-primary);background:var(--color-primary-surface);color:var(--color-primary)}.ebook-reader__footer{position:relative;z-index:12001;display:grid;grid-template-columns:132px minmax(220px,460px) 132px;align-items:center;justify-content:center;gap:22px;padding:12px 24px;border-top:1px solid var(--color-border-default);background:var(--color-surface-raised);box-shadow:0 -8px 24px rgba(40,48,65,.05)}.ebook-reader__nav-button{height:44px}.ebook-reader__progress{display:grid;grid-template-columns:minmax(120px,1fr) auto auto;align-items:center;gap:12px;padding:8px 12px;border:0;background:transparent;color:var(--color-text-secondary);cursor:pointer}.ebook-reader__progress>span{height:4px;overflow:hidden;border-radius:99px;background:var(--color-border-subtle)}.ebook-reader__progress i{display:block;height:100%;border-radius:inherit;background:var(--color-primary-solid)}.ebook-reader__progress strong{font-size:13px}.ebook-reader__progress small{font-size:12px;color:var(--color-text-muted)}.ebook-reader-fade-enter-active,.ebook-reader-fade-leave-active{transition:opacity .18s ease}.ebook-reader-fade-enter-from,.ebook-reader-fade-leave-to{opacity:0}@media(max-width:900px){.ebook-reader__surface{padding:24px 20px}.ebook-reader__paper{padding:44px 38px}.ebook-reader__footer{grid-template-columns:48px minmax(160px,1fr) 48px;gap:10px}.ebook-reader__nav-button{font-size:0}.ebook-reader__nav-button :deep(svg){font-size:16px}.ebook-reader__progress{grid-template-columns:1fr auto}.ebook-reader__progress small{display:none}}
