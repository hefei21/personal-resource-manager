...
.transport,.secondary-controls,.volume{display:flex;align-items:center;gap:6px}.icon-button{position:relative;border:0;background:transparent;border-radius:6px;min-width:36px;height:36px;padding:6px;display:inline-flex;align-items:center;justify-content:center}.icon-button:hover{background:var(--color-surface-subtle,#eff1f4)}.icon-button.primary{background:var(--color-primary,#6266da);color:white;border-radius:50%;width:40px;height:40px}.timeline{flex:1;min-width:120px;display:flex;align-items:center;gap:10px;font-size:12px;font-variant-numeric:tabular-nums;color:var(--color-text-secondary,#657184)}
...
.queue-heading{display:flex;justify-content:space-between;align-items:center;font-size:13px;color:var(--color-text-secondary,#657184)}.queue-row{display:flex;align-items:center;border-bottom:1px solid var(--color-border-subtle,#e2e5eb)}.queue-row.active{background:var(--color-primary-light,#f0f0ff)}.queue-track{border:0;background:none;display:flex;align-items:center;gap:14px;flex:1;min-width:0;text-align:left;padding:14px 8px}.queue-track>span:last-child{display:grid;gap:4px;min-width:0}.queue-track strong{font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.queue-track small,.queue-track>span:first-child{font-size:12px;color:var(--color-text-secondary,#657184)}.empty-queue{font-size:14px;color:var(--color-text-secondary,#657184)}
